...
public class Stopover implements Comparable<Stopover>{
	...
	public Stopover(Airport airport, Double weight){
        ...
        public Stopover(Stopover previousStop, Airport finalDestination,Flight newFlight, Double weight){
		criteriaWeight = weight;
		this.finalDestination = finalDestination;
		this.flights = previousStop.getFlights();
	...
	public void setWeight(Double weight){
        ...
        public void printStopover() {
            System.out.println("Se llego a " + finalDestination.toString() + " por $" + criteriaWeight.toString());
